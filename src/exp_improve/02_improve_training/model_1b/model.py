...
- Added return_features option to forward() for feature distillation
"""
...
class InSiteDTA(nn.Module):
    ...
    def forward(self, x_in, mol_data=None, return_attn_map=False, return_features=False):
        ...
        dec1_pred_pocket = dec1 * pred_pocket_mask
        ...
        if return_features:
            return logits, regression_output, bottleneck_p2l
